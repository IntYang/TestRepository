...
<html>
	...
	<body>
		...
		<table style="background-color: aqua; border:1px solid black; height:50px; width:100%">
			<tr>
			<td>table 태그</td>
			</tr>
		...
		<image style="border:1px solid black;" src="/WebApplication/resources/image/Penguins.jpg" height="50px"/>
