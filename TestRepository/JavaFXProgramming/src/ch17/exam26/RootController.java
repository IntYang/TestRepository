...
//        areaChart.getData().add(series1); // 이렇게 하면 bar차트의 데이터가 에리아 차트로 옴, 데이터 공유불가!!
        ...
        areaChart.getData().add(series3); // 이렇게 하면 bar차트의 데이터가 에리아 차트로 옴, 데이터 공유불가!!
        
        XYChart.Series<String, Integer> series4 = new XYChart.Series<>();
        series4.setName("평균 속도");
        ...
        data5.add(new XYChart.Data<String, Integer>("2016", 8));
        data5.add(new XYChart.Data<String, Integer>("2017", 19));
        data5.add(new XYChart.Data<String, Integer>("2018", 2));
