...
<html>
	<head>
		...
		<body>
			...
			<a href="css/exam02" class="btn btn-success">exam01</a>
			<a href="css/exam03" class="btn btn-success">exam01</a>
			...
			%>
				<a href="jquery/
					 <%=exam%>" class="btn btn-primary"> <%=exam%> </a>
			<%}%>
			...
			<h4>파일 업로드</h4>
			<a href="form/exam02" class="btn btn-primary">파일업로드</a>
