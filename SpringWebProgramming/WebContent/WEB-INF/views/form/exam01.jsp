...
<html>
	<head>
		...
		<script src="<%=application.getContextPath()%>/jquery/jquery.js" type="text/javascript"></script>
		<script src="<%=application.getContextPath()%>/bootstrap-3.3.7/js/bootstrap.min.js" type="text/javascript"></script>		
	</head>
	<body>
		<h3>회원 가입</h3>
		<form method="post" action="exam02" style="padding: 0px 20px" enctype="multipart/form-data">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<input type="" class="form-control" placeholder="생년월일" name="mbirth"/>
				</div>
			</div>
