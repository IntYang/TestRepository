...
<html>
	...
	<body>
		...
		<a href ="jdbc/exam05" class="btn btn-primary">게시물 페이지 목록(board)</a>
		
		<a href ="jdbc/exam06" class="btn btn-primary">게시물 페이지 목록(member)</a>
		...
		<a href ="websocket/measureClient" class="btn btn-primary">측정값얻기</a>
