...
public class MqttSubscribeService extends Service {
    ...
    private String serverURI = "tcp://192.168.3.144:1883";
    ...
    private MqttCallback mqttCallback = new MqttCallback() {
        ...
        public void messageArrived(String topic, MqttMessage message) throws Exception {
            ...
            PendingIntent pendingIntent = TaskStackBuilder.create(MqttSubscribeService.this)
                    .addParentStack(MqttActivity.class) // Manifest 파일에서 이전 화면에 정보를 이용해서 스택에 넣음
             ...
             mqttAndroidClient.connect()
                     .setActionCallback(new IMqttActionListener() {
                         ...
                         public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                             Log.i(TAG, "MQTT 연결 실패: " + exception.toString());
                             stopSelf();
                         }
                     });

            }catch(MqttException e){
                Log.i(TAG, "MQTT 연결 실패: " +e.toString());
                stopSelf();
            }
